...
const Page = () => {
  return (
    <div>
      <Header />
      <div className="flex flex-col h-screen items-center bg-[#F4F4F4]">
        ...
        <div className="w-7/12 bg-[#F4F4F4] px-4 lg:px-16">
          ...
          <div className="flex flex-col w-full">
            <div className="flex flex-col gap-3 lg:flex-row lg:gap-4 w-full">
              ...
              <span className="mb-2 pl-3 text-4xs lg:text-sm font-medium">
                Name
              </span>
              <div className="w-full rounded-md text-black px-2 py-2 border-black border-solid border-2">
                <input
                  className="bg-[#F4F4F4] w-full placeholder:italic placeholder:text-black placeholder:font-light placeholder:opacity-40 border-0 outline-0 font-medium text-5xs px-2 text-black"
          ...
          <div className="h-6 lg:h-4"></div>
            <div className="w-full rounded-md text-black px-2 py-2 border-black border-solid border-2">
              <textarea
                className="bg-[#F4F4F4] w-full h-32 placeholder:italic placeholder:text-black placeholder:font-light placeholder:opacity-40 border-0 outline-0 font-medium text-5xs px-2 text-black"
